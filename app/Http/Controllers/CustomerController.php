...
{ 
    ...
    { 
        try { 
            ...
            // pastikan user yang login selalu pakai data terbaru dari Google
            $googleId = $socialUser->getId();
            $googleName = $socialUser->getName();
            $googleEmail = $socialUser->getEmail();
            ...
            if (!$registeredUser) {
                ...
                // Pastikan kolom google_id/google_token tersinkron
...
// DETAIL
   ...
   // UPDATE (untuk admin)
    public function update(Request $request, $id)
    {
        ...
        // Update tabel users (nama, email, foto)
        $user->update($validatedData);

        // Update tabel customers (alamat, pos)
        $customer->update([
